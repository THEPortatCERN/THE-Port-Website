...
For more info, visit https://reactjs.org/link/mock-scheduler`);
      ...
      (function(global, factory) {
        ...
        var Input = /* @__PURE__ */ function(superclass) {
          ...
          Input2.prototype.render = function render() {
            ...
            var index = ref.index;
            return React__default["default"].createElement("div", { className: classNames.searchWrapper }, React__default["default"].createElement("input", Object.assign({}, inputAttributes, inputEventHandlers, { ref: this.input, value: query, placeholder: placeholderText, className: classNames.searchInput, role: "combobox", "aria-autocomplete": "list", "aria-label": ariaLabelText || placeholderText, "aria-owns": id, "aria-activedescendant": index > -1 ? id + "-" + index : null, "aria-expanded": expanded, style: { width: this.state.inputWidth } })), React__default["default"].createElement("div", { ref: this.sizer, style: SIZER_STYLES }, query || placeholderText));
          };
          return Input2;
        ...
        var ReactTags2 = /* @__PURE__ */ function(superclass) {
          ...
          if (superclass)
            ReactTags3.__proto__ = superclass;
          ReactTags3.prototype = Object.create(superclass && superclass.prototype);
          ReactTags3.prototype.constructor = ReactTags3;
          ReactTags3.prototype.onInput = function onInput(e) {
          ...
          ReactTags3.prototype.onKeyDown = function onKeyDown(e) {
          ...
          ReactTags3.prototype.onClick = function onClick(e) {
            if (document.activeElement !== e.target) {
              this.focusInput();
            }
          };
          ReactTags3.prototype.onBlur = function onBlur() {
          ...
          ReactTags3.prototype.onFocus = function onFocus() {
            this.setState({ focused: true });
            if (this.props.onFocus) {
              this.props.onFocus();
            }
          };
          ReactTags3.prototype.onDeleteTag = function onDeleteTag(index, event) {
            if (this.container.current) {
              focusNextElement(this.container.current, event.currentTarget);
            }
            this.deleteTag(index);
          };
          ReactTags3.prototype.addTag = function addTag(tag) {
            if (tag.disabled) {
              return;
            }
          ...
          ReactTags3.prototype.deleteTag = function deleteTag(i) {
            this.props.onDelete(i);
          };
          ReactTags3.prototype.clearInput = function clearInput() {
            this.setState({
              query: "",
              index: -1
            });
          };
          ReactTags3.prototype.clearSelectedIndex = function clearSelectedIndex() {
            this.setState({ index: -1 });
          };
          ReactTags3.prototype.focusInput = function focusInput() {
            if (this.input.current && this.input.current.input.current) {
              this.input.current.input.current.focus();
            }
          };
          ReactTags3.prototype.render = function render() {
            var this$1$1 = this;
  ...
  var doesProjectMatch = (project, tags, chosenSDGs, titleSearch) => {
    ...
    return projectMatchesTags && projectMatchesSDGs && projectMatchesTitleSearch;
  };
  ...
  var ProjectCard = ({
    ...
    return /* @__PURE__ */ import_react.default.createElement("article", {
    ...
    }, image_src ? /* @__PURE__ */ import_react.default.createElement("img", {
      className: "img-fluid",
      loading: "lazy",
      alt: image_alt,
      src: image_src
      ...
      loading: "lazy",
      alt: "Empty",
      src: `${settings_default.baseUrl}images/empty.svg`
    })), /* @__PURE__ */ import_react.default.createElement("div", {
      className: "card-body"
  ...
  var TagInput = ({ setTags, tags }) => {
    ...
    const onAddition = (0, import_react3.useCallback)((newTag) => {
      setTags([...tags, newTag]);
    }, [setTags, tags]);
    ...
    return /* @__PURE__ */ import_react3.default.createElement(import_react_tag_autocomplete.default, {
      ref: reactTags,
      tags,
  ...
  var SDG = ({ setChosenSDGs, chosenSDGs }) => {
    const onDelete = (0, import_react4.useCallback)((e) => {
      setChosenSDGs(chosenSDGs.filter((sdg) => sdg !== e.target.alt));
    }, [setChosenSDGs, chosenSDGs]);
    const onAddition = (0, import_react4.useCallback)((e) => {
    ...
    return /* @__PURE__ */ import_react4.default.createElement("div", {
      ...
      className: "sdg-list"
    }, settings_default.sdgs.map((sdg) => !chosenSDGs.includes(sdg.name) ? /* @__PURE__ */ import_react4.default.createElement("img", {
      src: sdg.image_src,
      alt: sdg.name,
      onClick: onAddition,
      key: sdg.id,
  ...
  function App() {
    ...
    const [chosenSDGs, setChosenSDGs] = (0, import_react5.useState)([]);
    const [titleSearch, setTitleSearch] = (0, import_react5.useState)("");
    ...
    }, "Choose Filters"), /* @__PURE__ */ import_react5.default.createElement("button", {
      type: "button",
    ...
    }), /* @__PURE__ */ import_react5.default.createElement(SDGlist_default, {
      chosenSDGs,
      setChosenSDGs,
      className: "single-filter-system"
    }))), /* @__PURE__ */ import_react5.default.createElement("div", {
    ...
    }, filteredList.length > 0 ? filteredList.map((project, index) => /* @__PURE__ */ import_react5.default.createElement(ProjectCard_default, __spreadProps(__spreadValues({}, project), {
      key: index
